<?php
    ...
    if(isset($_POST['simpan'])){
        ...
        $query_insert = "insert into manual_deductions (userid, name, amount, payroll_month, payroll_year) values ('$userid', '$name', '$amount', '$payroll_month', '$payroll_year')";
